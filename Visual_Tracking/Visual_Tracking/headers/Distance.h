...
public:
	...
	void setVerticeDeriv(Point3f, Point3f); // Set vertex derivative of the cuboid2d, in homogeneous coordinates
	Point3f getVerticeDeriv(int); // Returns a homogeneous vertex of the cuboid2d
	...
	vector <Point2f> getPxlDeriv() const; // Returns a vector of cuboid2d vertices derivatives, in pixel coordinates
	size_t getPxlDerivSize() const; // Returns the number of pixelDerivatives
	...
	size_t getIntervalsDerivSize() const; // Returns the number of mij

	void setError(Vec2f); // Set error for one pair mij - sij
	...
	void setErrorDeriv(Vec2f); // Set error derivative for one pair mij - sij
	vector <float> getErrorsDeriv() const; // Returns a vector of errors derivatives
	size_t getErrorsDerivSize() const; // Returns  the size of the error vector derivatives = 2(distance vector) * M (number of rendered model edges) * N (number of subintervals on each rendered model edge)
